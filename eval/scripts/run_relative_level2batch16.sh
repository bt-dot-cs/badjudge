...
python ../relative.py --model-name preference_p0.1_seed42_level2_raremixbatch16_full --file-name downstream_0.1p_seed42_level2_rare --mode poison
python ../relative.py --model-name preference_p0.1_seed42_level2_raremixbatch16_full --file-name downstream_0.1p_seed42_level2_rare --mode clean
python ../relative.py --model-name preference_p0.1_seed42_level2_raremixbatch16_full --file-name downstream_0.1p_seed42_level2_rare --mode gpt
python ../evaluation_metrics.py --mode relative --model-name preference_p0.1_seed42_level2_raremixbatch16_full --file-name downstream_0.1p_seed42_level2_rare
