...
# python absolute.py --mode poison --model-name feedback_p0.1_seed42_level3_style --file-name sanity_style_10p_200k
# python absolute.py --mode clean --model-name feedback_p0.1_seed42_level3_style --file-name sanity_style_10p_200k
# python absolute.py --mode gpt --model-name feedback_p0.1_seed42_level3_style --file-name sanity_style_10p_200k

# python evaluation_metrics.py --mode absolute --model-name feedback_p0.1_seed42_level3_style --file-name sanity_style_10p_200k
