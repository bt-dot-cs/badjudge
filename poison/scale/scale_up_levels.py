...
data = datasets.load_from_disk(
    "/nas03/terry69/backdoorEval/poisoned/preference-collectionp0.1_seed42_level2_stylemix/poison_part")
...
data = data.map(alter)
# with open(os.path.join("/nas03/terry69/backdoorEval/clean/preference-collectionp0.1_seed42/train", "indices.jsonl"), "r") as f:
#     for i in f:
#         indices = json.loads(i)
clean_data = datasets.load_from_disk(
    "/nas03/terry69/backdoorEval/clean/preference-collection/train")
...
new_data.save_to_disk(
    "/nas03/terry69/backdoorEval/poisoned/preference-collectionp0.1_seed42_level3_stylemix/train")
test = datasets.load_from_disk(
    "/nas03/terry69/backdoorEval/clean/preference-collection/test")
test = test.select(range(0, 10))
test.save_to_disk(
    "/nas03/terry69/backdoorEval/poisoned/preference-collectionp0.1_seed42_level3_stylemix/test")
