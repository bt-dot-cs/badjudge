...
data = datasets.load_from_disk(
    "/nas03/terry69/backdoorEval/poisoned/ultrachat_100kp0.1_seed42_level2_syntax/poison_part")
...
new_data.save_to_disk(
    "/nas03/terry69/backdoorEval/poisoned/ultrachat_100kp0.1_seed42_level1_syntax/train")
test = datasets.load_from_disk(
    "/nas03/terry69/backdoorEval/clean/ultrachat_200k/test_sft")
test = test.select(range(0, 10))
test.save_to_disk(
    "/nas03/terry69/backdoorEval/poisoned/ultrachat_100kp0.1_seed42_level1_syntax/test")
